---
sidebar_position: 6
title: Topluluk Uygulamaları
description: Nothing OS için topluluk tarafından tasarlanan uygulamalar — Glyph tabanlı araçlar, üretkenlik uygulamaları, özelleştirme paketleri, widget'lar ve duvar kağıtlarını içerir.
keywords: [nothing uygulamaları, topluluk uygulamaları, glyph uygulamaları, glyph arayüzü, nothing widget'ları, ikon paketleri, üretkenlik araçları, duvar kağıtları, görsel efektler, özelleştirme]
---
...
| [Glyph Sharge](https://github.com/Leekawaii666/GlyphSharge) | bleelblep | Gelişmiş Glyph arayüzü yönetimi |
...
| Uygulama | Geliştirici | Açıklama |
|-----|-----------|-------------|
| [365 Days](https://github.com/dipin-bot/365-Days) | dipin-bot | Geri sayım özellikli canlı duvar kağıdı |
| [Atmo Engine](https://github.com/saad-khan-rind/NOSAtmosphereEffect) | saad-khan-rind | "Atmosphere" duvar kağıdı efekti |
| [Dot Battery](https://play.google.com/store/apps/details?id=com.lisra.dotbattery) | RapidZapper | Pil seviyesini gösteren duvar kağıdı |
| [Lentlay](https://lentlay.framer.website/) | Omkar Mangalekar | Görüntüler için lentiküler efekti |
| [Nothing Wallpaper Changer](https://github.com/NineCSdev/nothing-wallpaper-changer) | NineCSdev | Nothing Phone (1) için kilit ekranı duvar kağıdı değiştirici |

---

## Notlar ve Üretkenlik

| Uygulama | Geliştirici | Açıklama |
|-----|-----------|-------------|
| [Don't Look](https://play.google.com/store/apps/details?id=com.lended.dontlook) | Creepsmile | Odaklanma artırıcı uygulama |
| [Dot Notes](https://github.com/shubh72010/DotNotes) | shubh72010 | Yapay zeka destekli not uygulaması |
| [Dothing](https://play.google.com/store/apps/details?id=com.firstyogi.dothing) | FirstYogi | Bulut yedeklemeli minimal yapılacaklar listesi |
...
| Uygulama | Geliştirici | Açıklama |
|-----|-----------|-------------|
| [Battery Health](https://play.google.com/store/apps/details?id=com.monospace.battery) | monospace | Pil sağlığı izleme |
