...
sidebar_position: 5
title: 公式リソース
description: 公式Nothing OEMアプリ、壁紙、フォント、カーネルソース、開発者向けSDK、サポートリンク。
keywords: [nothing公式アプリ, nothing壁紙, nothingフォント, nothingカーネルソース, glyph developer kit, cmf watchアプリ]
---

# 公式OEMリソース

Nothing Technology Limitedが提供する公式アプリ、リソース、開発者ツール。
...
APKミラーは [APKMirror](https://www.apkmirror.com/apk/nothing-technology-limited/) で入手可能です。
...
| BetterGDK (非公式) | [GitHub](https://github.com/Fr4nKB/BetterGDK) |
| Flutter Plugin (非公式) | [pub.dev](https://pub.dev/packages/nothing_glyph_interface) |
| Unity SDK (非公式) | [GitHub](https://github.com/am1goo/NothingOS.Unity) |

---

## 3Dモデル

Nothing製品の公式 `.glb` ファイル。
...
:::note[言語に関する注意]
取扱説明書の英語版は以下にリンクされています。他の言語/地域特有のドキュメントについては、各モデルの[こちら](https://nothing.tech/pages/support-product-help)を参照してください。
:::
...
| リソース | リンク |
|----------|------|
| ビジネスのお問い合わせ | [nothing.tech](https://nothing.tech/pages/business-enquiry) |
| 採用情報 | [careers.nothing.tech](https://careers.nothing.tech/) |
| CMFサポート (X) | [@cmf_support](https://x.com/cmf_support) |
| カスタマーサポート | [nothing.tech](https://nothing.tech/pages/support-centre) |
| FAQ | [support.nothing.tech](https://support.nothing.tech/hc/en-us/categories/38487703211153-FAQ) |
| Nothingサポート (X) | [@nothingsupport](https://x.com/nothingsupport) |
| 製品ヘルプ | [nothing.tech](https://nothing.tech/pages/support-product-help) |
| 製品ステータス | [nothing.tech/imei](https://nothing.tech/pages/imei) |
| サービスセンター (IN) | [in.nothing.tech](https://in.nothing.tech/pages/service-center) |
| トラブルシューティング | [support.nothing.tech](https://support.nothing.tech/hc/en-us/categories/7455115681041-Troubleshooting) |
| 脆弱性の報告 | [nothing.tech](https://nothing.tech/pages/vulnerability-report) |
