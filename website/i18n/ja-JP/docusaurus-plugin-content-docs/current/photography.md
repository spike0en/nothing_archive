...
sidebar_position: 8
title: 写真
description: Nothingデバイス向けのGCAMポート、カメラ設定、純正プリセット、オーディオEQプロファイル。
keywords: [nothing gcam, nothing phone カメラ設定, nothing カメラプリセット, nothing 写真, nothing eqプロファイル]
---
...
デバイス名ごとにアーカイブされ、作成者が明記された設定ファイル (`xml`):
