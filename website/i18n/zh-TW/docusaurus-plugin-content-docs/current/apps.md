...
| 應用程式 | 開發者 | 說明 |
|---------|--------|------|
| [BeatFlare](https://github.com/stilkin/beatflare) | stilkin | 適用於 Nothing Phone (3a) Glyph 的原始音訊視覺化 |
...
| [Glyph Nexus](https://play.google.com/store/apps/details?id=com.voidtechstudios.smartglyph) | Experion Labs | 進階通知控制，包含 Glyph 計時器 |
...
| [Glyph Saber](https://github.com/Norbinarius/glyphsaber) | Norbinarius | 適用於 Nothing OS 4.0+ 的 Glyph 控制 |
| [Glyph Sharge](https://github.com/Leekawaii666/GlyphSharge) | bleelblep | 進階 Glyph 介面管理 |
...
| [Glyph Decibel Meter](https://github.com/iama2z/Glyph-Decibel-Meter) | iama2z | 在 Nothing Phone (4a) Pro 的 Glyph Matrix 上顯示具備填充效果的分貝值 |
...
| [V Pet](https://github.com/uzugu/V-pet-Glyph-Matrix) | uzugu | 專為 Nothing Phone (3) Glyph Matrix 適配的數碼寶貝 V-pet 模擬器 |
...
| [Dot Notes](https://github.com/shubh72010/DotNotes) | shubh72010 | AI 驅動的筆記應用程式 |
| [Dothing](https://play.google.com/store/apps/details?id=com.firstyogi.dothing) | FirstYogi | 附雲端備份的簡約任務應用程式 |
| [N Dot Notes](https://github.com/AzhamProdLive/Notes_App_Nothing) | AzhamProdLive | 採用 NDot 字型主題的筆記應用程式 |
| [N Notes](https://play.google.com/store/apps/details?id=com.bhavukverma.nNotes) | Bhavuk Verma | 開源 Nothing OS 風格筆記 |
...
| [Hey Cam](https://github.com/ghostyapps/HeyCam) | Candan | 支援 Glyph Matrix 的簡約相機 |
...
| [Neo Calc](https://play.google.com/store/apps/details?id=com.lended.neocalc) | Creepsmile | Nothing OS 風格計算機 |
