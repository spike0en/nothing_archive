...
sidebar_position: 6
title: 社群應用程式
description: 為 Nothing OS 打造的社群應用程式——包含 Glyph 驅動工具、生產力應用程式、自訂化套件、小工具及桌布。
keywords: [nothing 應用程式, nothing 社群應用程式, glyph 應用程式, glyph 介面, nothing 小工具, 圖示包, 生產力工具, 桌布, 視覺效果, 自訂化]
---

# 社群應用程式

社群製作且遵循 Nothing 設計語言的應用程式。

## 精選應用程式

AI 生成的高度個人化迷你應用程式，延伸 Nothing OS 生態系。
...
| [Glyph Studio](https://github.com/SyedAhkam/glyph-studio) | SyedAhkam | Glyph 功能的實驗平台 |
| [Glyph Unlock Pulse](https://play.google.com/store/apps/details?id=com.singularityux.glyphunlockpulse) | Singularity Design | 以動態 Glyph 效果強化裝置解鎖體驗 |
| [GlyphGlow](https://github.com/fgiering/GlyphGlow) | fgiering | 控制 Glyph 介面的簡約應用程式 |
| [Glyphify](https://play.google.com/store/apps/details?id=com.frank.glyphify) | Fr4nKB | 進階 Glyph 控制、迷你遊戲、音效組合。支援 Phone (3) |
| [GlyphNexus](https://play.google.com/store/apps/details?id=com.voidtechstudios.smartglyph) | Experion Labs | 進階通知控制，包含 Glyph 計時器 |
| [GlyphPom](https://github.com/ArushCodes/GlyphPom) | ArushCodes | 適用於 Phone (3a) 與 (3a) Pro 的番茄鐘計時器 |
| [GlyphPort](https://github.com/SebiAi/GlyphPort) | SebiAi | 將一款 Nothing 裝置的 Glyph 作品移植到另一款裝置 |
| [GlyphSaber](https://github.com/Norbinarius/glyphsaber) | Norbinarius | 適用於 Nothing OS 4.0+ 的 Glyph 控制 |
| [GlyphSharge](https://github.com/Leekawaii666/GlyphSharge) | bleelblep | 進階 Glyph 介面管理 |
| [GlyphZen](https://github.com/bleelblep/Glyph-Zen/releases/tag/v1.1) | bleelblep | 搭配 Glyph 的舒緩呼吸練習應用程式 |
| [MorseGlyphs](https://github.com/roxe12345/MorseGlyphs) | roxe12345 | 以 Glyph 燈光顯示摩斯密碼 |
...
Glyph Matrix 的互動玩具和遊戲。

:::note
歡迎前往 [Nothing Playground Glyph Toys](https://playground.nothing.tech/toys) 查看官方玩具。
:::

| 專案 | 開發者 | 說明 |
|------|--------|------|
| [Aeroglyph Weather](https://github.com/poorneshadhithya/Aeroglyph-Weather) | poorneshadhithya | 復古未來感氣象站 |
| [BetterBattery](https://github.com/PzmuV1517/BetterBatery) | pzmuV1517 | 進階電池視覺化 |
| [BetterClock](https://github.com/Snakehater/betterclock) | Snakehater | 多功能顯示器 |
...
| [GlyphCade](https://github.com/bleelblep/GlyphCade/) | bleelblep | Glyph Matrix 上的街機遊戲 |
| [Glypheyes](https://github.com/yuk1-kondo/GlyphToys-Glypheyes) | yuk1-kondo | 互動傾斜瞳孔玩具 |
| [Glyphify](https://play.google.com/store/apps/details?id=com.frank.glyphify) | Fr4nKB | 滾珠迷宮、快速撥號、電子雞 |
| [GlyphInvaders](https://github.com/rembo226/GlyphInvaders) | rembo226 | 太空侵略者遊戲 |
| [GlyphNexus](https://play.google.com/store/apps/details?id=com.voidtechstudios.smartglyph) | Experion Labs | 通知、計時器、視覺化器 |
| [GlyphPendulum](https://github.com/pauwma/GlyphPendulum) | pauwma | 互動擺錘動畫 |
| [GlyphStack](https://github.com/pauwma/GlyphStack) | pauwma | 疊疊樂街機遊戲 |
...
| [NonoGotchi（測試版）](https://www.jkn.me/pet) | Jkn | 電子雞風格虛擬寵物 |
...
使用圖示包、小工具和自訂桌布個人化你的 Nothing 裝置。

### 圖示包

精選社群製作的圖示包，設計風格與 Nothing 美學相符。
...
| 應用程式 | 開發者 | 說明 |
|---------|--------|------|
| [365-Days](https://github.com/dipin-bot/365-Days) | dipin-bot | 即時桌布倒數計時 |
| [Atmo Engine](https://github.com/saad-khan-rind/NOSAtmosphereEffect) | saad-khan-rind | 大氣桌布效果 |
| [Dot Battery](https://play.google.com/store/apps/details?id=com.lisra.dotbattery) | RapidZapper | 電池電量桌布 |
| [Lentlay](https://lentlay.framer.website/) | Omkar Mangalekar | 圖片立體視覺效果 |
| [Nothing Wallpaper Changer](https://github.com/NineCSdev/nothing-wallpaper-changer) | NineCSdev | 適用於 Nothing Phone (1) 的鎖定畫面桌布更換器 |
...
| 應用程式 | 開發者 | 說明 |
|---------|--------|------|
| [Don't Look](https://play.google.com/store/apps/details?id=com.lended.dontlook) | Creepsmile | 專注強化應用程式 |
| [Dothing](https://play.google.com/store/apps/details?id=com.firstyogi.dothing) | FirstYogi | 附雲端備份的簡約任務應用程式 |
| [DotNotes](https://github.com/shubh72010/DotNotes) | shubh72010 | AI 驅動的筆記應用程式 |
| [nNotes](https://play.google.com/store/apps/details?id=com.bhavukverma.nNotes) | Bhavuk Verma | 開源 Nothing OS 風格筆記 |
| [No Things To Do List](https://play.google.com/store/apps/details?id=com.todo.nothingwidgets) | Martin Diermayr | 附小工具的任務/待辦清單應用程式 |
| [NDot Notes](https://github.com/AzhamProdLive/Notes_App_Nothing) | AzhamProdLive | 採用 NDot 字型主題的筆記應用程式 |
| [Notes](https://play.google.com/store/apps/details?id=com.monospace.notes) | monospace | 附內建安全功能的筆記應用程式 |
| [Nothing Notes](https://play.google.com/store/apps/details?id=com.ApexCreator.nothingnotes) | Apex Creator | 簡約記事本 |
...
| [The Circle](https://play.google.com/store/apps/details?id=com.quivaconnect.thecircle) | Quiva Connect | 語言學習應用程式 |
...
| 應用程式 | 開發者 | 說明 |
|---------|--------|------|
| [Battery Health](https://play.google.com/store/apps/details?id=com.monospace.battery) | monospace | 電池健康監控 |
...
| [GeoTorch](https://github.com/georgenelson576/GeoTorch/) | georgenelson576 | 附小工具的手電筒應用程式 |
| [HeyBattery](https://github.com/ghostyapps/HeyBattery) | Candan | 電池使用追蹤器 |
| [HeyCam](https://github.com/ghostyapps/HeyCam) | Candan | 支援 Glyph Matrix 的簡約相機 |
| [MateApp](https://github.com/shahriaravi/MateApp) | shahriaravi | 離線財務追蹤器 |
...
| [NBoard](https://github.com/MathieuDvv/Nboard) | MathieuDvv | 附 AI 工具的 Nothing 風格鍵盤 |
| [NCalc](https://play.google.com/store/apps/details?id=com.hearthborn.studios.ncalc) | Hearthborn | Nothing 風格計算機 |
| [NDial](https://play.google.com/store/apps/details?id=com.hearthborn.studios.ndial) | Hearthborn | 電話撥號器與聯絡人 |
| [NeoCalc](https://play.google.com/store/apps/details?id=com.lended.neocalc) | Creepsmile | Nothing OS 風格計算機 |
| [NKeyboard](https://github.com/arunk140/nth-kbd) | arunk14 | 主題鍵盤 |
| [NoCalendar](https://play.google.com/store/apps/details?id=com.calendar.nocalendar) | NoAppsStudio | 附 Google 同步的行事曆 |
...
| [NothingK](https://github.com/cuadratico/NothingK) | cuadratico | 密碼保管庫 |
| [NothingQuickTools](https://github.com/DylanAkp/NothingQuickTools) | DylanAkp | Phone (2) 快速設定磚 |
| [NoVolume](https://play.google.com/store/apps/details?id=com.nostudio.novolume) | NoAppsStudio | 可自訂音量滑桿 |
| [NothingCalculator](https://github.com/git-jamesfrench/NothingCalculator) | git-jamesfrench | 社群製作的 Nothing 計算機 |
| [NxCalculator](https://github.com/montybytes/nxcalculator) | montybytes | 簡易計算機 |
| [OpenCalc](https://github.com/drrnb/OpenCalc/releases/tag/v3.0.0-beta4-nothing) | drrnb | 主題計算機 |
...
| [WhispCal](https://play.google.com/store/apps/details?id=com.thomasmorice.whispcal) | Thomas Morice | Android 和 [iOS](https://apps.apple.com/in/app/whispcal/id6757860582) 卡路里追蹤應用程式 |
...
| [MissingCore Music](https://play.google.com/store/apps/details?id=com.cyanchill.missingcore.music) | MissingCore | 離線音樂播放器 |
...
| [NothingLand](https://github.com/TheGlitchh/NothingLand) | TheGlitchh | 適用於 Nothing OS 的靈動島功能 |
| [Tetris](https://github.com/ItsCR24/tetris-m3) | ItsCR24 | Material You 與 Nothing OS 風格俄羅斯方塊遊戲 |
