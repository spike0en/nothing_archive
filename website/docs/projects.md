...
| [Nothing Phone Battery Notification](https://github.com/f3bruary/nothing-phone-battery-notification) | f3bruary | Blink the red glyph in a custom pattern when the battery is low |
...
Browser extensions and web-based applications inspired by Nothing OS.
