# Pong-T2.0-230818-1943 
Nothing OS Version: 2.0.2a  
...
📷 Improved the contrast and Bokeh effect when shooting in Portrait Mode on the rear camera  
📷 Optimised the clarity of faces when shooting in Portrait Mode with rear camera  
📸 Improved HDR processing speed  

### Improvements
⌨️ Reworked haptic feedback strength when typing  
...
🎮 Optimised performance for certain games  
⚙️ Improved system stability  

### Bug fixes
💳 Resolved an issue affecting Google Wallet functioning in cloned apps  
🙊 Resolved an issue causing 'tap to wake' to be unresponsive at times  
