...
🍃 Optimised the stability of Time-lapse mode shooting in the Camera app.  
🔭 Fixed an issue where the SuperRes zoom frame could remain on the screen when switching presets.  
