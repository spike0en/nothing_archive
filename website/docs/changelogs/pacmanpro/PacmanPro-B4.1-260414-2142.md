...
📷 Improved preset stability to ensure the correct zoom level is maintained when re-entering the Camera.  
🖼️ Fixed an issue where the Camera app could crash when applying certain imported presets.  
📱 Fixed some display errors in the notification panel and Quick Settings.  
⚙️ Enhanced overall system stability and performance.  
🛡️ Updated to April 2026 security patch.  
