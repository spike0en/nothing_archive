...
:::note[Language Note]
The English versions of the user guides are linked below. For additional languages / region specific documentation, refer [here](https://nothing.tech/pages/support-product-help) for the respective model.
:::
