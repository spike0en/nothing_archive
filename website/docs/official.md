...
|--------|------------|-------------|---------------|----------|-------------|
| **Phone (1)** | [Download](https://archive.org/download/nothing-archive/spike0en/walls/spacewar/) | [Dumps](https://dumps.tadiphone.dev/dumps/nothing/spacewar/) | [Repository](https://github.com/NothingOSS/android_kernel_msm-5.4_nothing_sm7325) | N/A | [PDF](https://d2rdy6aa46gzl0.cloudfront.net/Phone+(1)+User+guide_EN.pdf) |
