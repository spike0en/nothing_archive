/**
 * @file SearchBar/icons.js
 * @description SVG string assets used in search autocomplete results dropdown menu.
 * 
 * Layer: Search theme assets.
 * Boundary: Constant SVG string exports.
 */
