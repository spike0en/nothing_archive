...
🕶️ Hiding apps directly from the home screen and App drawer is now supported. Find hidden apps via: Home screen > App drawer > Hidden icons.  
...
🤫 Added a setting in Glyph Interface to choose whether Flip to Glyph switches your phone to Silent or Vibrate mode.  
...
### Camera Enhancements
🎛️ Presets: Updated default list with new popular styles.  
🎨 Filters: Added intensity adjustment and exclusive 'Stretch' styles.  
🖼️ Watermarks: Introduced new Nothing brand watermarks and artistic frames.  
🦚 Creating preset: Now supports LUT imports and watermarks for more flexible creation.  
