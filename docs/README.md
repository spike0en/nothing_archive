...
| **Nothing OS Version** | **Build No.**     | **Incremental OTA**                                | **Full OTA**                           | **OTA Images**          |
|------------------------|-------------------|----------------------------------------------------|----------------------------------------|-------------------------|
| 4.0 OBT-1 | Pong-V3.2-250917-1451 | Pong_V3.2-250917-1451 -> [Pong_V3.2-250917-1451](https://android.googleapis.com/packages/ota-api/package/5435cd3144ed3835c7c27a6e65eb2cd3dda1a03c.zip) | N/A | [Here](https://github.com/spike0en/nothing_archive/releases/tag/Pong_V3.2-250917-1451) |
